...
def booster_t1_23_penalty_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    ...
    # --- scegli verso quale porta vuoi tirare ---
    # goal a +x, quindi palla e robot devono stare con x < 7.3 e guardare +x
    GOAL_X = 7.3
    BALL_R = 0.11
    ...
    goal_left_cfg.init_state.pos = (GOAL_X, 0.0, 0.0)
    goal_left_cfg.init_state.rot = (0.0, 0.0, 0.0, 1.0)

    goal_right_cfg = get_robocup_goalpost_cfg()
    goal_right_cfg.init_state.pos = (-GOAL_X, 0.0, 0.0)
